...
2. [Архитектура проекта 🏢](#архитектура-проекта-)
   ...
   - [Схема работы проекта](#схема-работы-)
...
3. Перейдите в директорию с проектом, если необходимо:
    ...
    ```
4. Выполните конфигурацию `.env` файла, если необходимо.
5. Убедитесь, что Docker-engine запущен.
6. В терминале выполните следующую команду для запуска сервисов:
    ```bash
